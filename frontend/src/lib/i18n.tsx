...
const en: Dict = {
  ...
  "sidebar.writeKey": "Write API Key",
  "sidebar.writeKeySet": "set",
  "sidebar.writeKeyMissing": "missing",
  "sidebar.writeKeyPrompt": "Enter API write key (leave empty to clear):",
  ...
  "cc.sources": "sources",
  "cc.last": "Last",
  "cc.pipelineUnavailable": "Pipeline status unavailable",
  ...
  "situations.notFound": "Situation not found",
  "situations.back": "Back to Situations",
  "situations.eventTimeline": "Event Timeline",
  "situations.noLinkedEvents": "No linked events found in loaded data",
  "situations.annotations": "Annotations",
  "situations.sharedLog": "Shared operations log",
  "situations.localFallback": "Local fallback mode",
  "situations.localFallbackAuth": "Shared API unavailable (auth/config). Local fallback mode",
  "situations.add": "Add",
  "situations.swissImpact": "Swiss Impact Assessment",
  "situations.recommendedActions": "Recommended Actions",
  ...
  "watchlists.sharedSynced": "Shared watchlist state synced",
  "watchlists.localFallback": "Shared API unavailable. Local watchlist mode",
  "watchlists.localFallbackAuth": "Shared API unavailable (auth/config). Local watchlist mode",
  ...
  "detail.sharedSynced": "Shared state synced",
  "detail.localFallback": "Local fallback mode",
  "detail.localFallbackAuth": "Shared API unavailable (auth/config). Local fallback mode",
...
const de: Dict = {
  ...
  "sidebar.writeKey": "API-Schlüssel (Schreiben)",
  "sidebar.writeKeySet": "gesetzt",
  "sidebar.writeKeyMissing": "fehlt",
  "sidebar.writeKeyPrompt": "API-Schreibschlüssel eingeben (leer lassen zum Löschen):",
  ...
  "cc.sources": "Quellen",
  "cc.last": "Zuletzt",
  "cc.pipelineUnavailable": "Pipeline-Status nicht verfügbar",
  ...
  "situations.notFound": "Situation nicht gefunden",
  "situations.back": "Zurück zu Situationen",
  "situations.eventTimeline": "Ereignis-Zeitleiste",
  "situations.noLinkedEvents": "Keine verknüpften Ereignisse in den geladenen Daten gefunden",
  "situations.annotations": "Anmerkungen",
  "situations.sharedLog": "Geteiltes Operationsprotokoll",
  "situations.localFallback": "Lokaler Fallback-Modus",
  "situations.localFallbackAuth": "Geteilte API nicht verfügbar (Auth/Konfiguration). Lokaler Fallback-Modus",
  "situations.add": "Hinzufügen",
  "situations.swissImpact": "Schweizer Wirkungsbeurteilung",
  "situations.recommendedActions": "Empfohlene Maßnahmen",
  ...
  "watchlists.sharedSynced": "Geteilter Watchlist-Status synchronisiert",
  "watchlists.localFallback": "Geteilte API nicht verfügbar. Lokaler Watchlist-Modus",
  "watchlists.localFallbackAuth": "Geteilte API nicht verfügbar (Auth/Konfiguration). Lokaler Watchlist-Modus",
  ...
  "detail.sharedSynced": "Geteilter Status synchronisiert",
  "detail.localFallback": "Lokaler Fallback-Modus",
  "detail.localFallbackAuth": "Geteilte API nicht verfügbar (Auth/Konfiguration). Lokaler Fallback-Modus",
...
const fr: Dict = {
  ...
  "sidebar.writeKey": "Clé API écriture",
  "sidebar.writeKeySet": "définie",
  "sidebar.writeKeyMissing": "absente",
  "sidebar.writeKeyPrompt": "Saisir la clé API d'écriture (laisser vide pour effacer) :",
  ...
  "cc.sources": "sources",
  "cc.last": "Dernier",
  "cc.pipelineUnavailable": "Statut du pipeline indisponible",
  ...
  "situations.count": "situations",
  "situations.notFound": "Situation introuvable",
  "situations.back": "Retour aux situations",
  "situations.eventTimeline": "Chronologie des événements",
  "situations.noLinkedEvents": "Aucun événement lié trouvé dans les données chargées",
  "situations.annotations": "Annotations",
  "situations.sharedLog": "Journal d'opérations partagé",
  "situations.localFallback": "Mode de secours local",
  "situations.localFallbackAuth": "API partagée indisponible (auth/config). Mode de secours local",
  "situations.add": "Ajouter",
  "situations.swissImpact": "Évaluation de l'impact suisse",
  "situations.recommendedActions": "Actions recommandées",
  ...
  "watchlists.sharedSynced": "État partagé de la liste synchronisé",
  "watchlists.localFallback": "API partagée indisponible. Mode liste local",
  "watchlists.localFallbackAuth": "API partagée indisponible (auth/config). Mode liste local",
  ...
  "detail.sharedSynced": "État partagé synchronisé",
  "detail.localFallback": "Mode de secours local",
  "detail.localFallbackAuth": "API partagée indisponible (auth/config). Mode de secours local",
...
const it: Dict = {
  ...
  "sidebar.writeKey": "Chiave API scrittura",
  "sidebar.writeKeySet": "impostata",
  "sidebar.writeKeyMissing": "mancante",
  "sidebar.writeKeyPrompt": "Inserisci la chiave API di scrittura (lascia vuoto per cancellare):",
  ...
  "cc.sources": "fonti",
  "cc.last": "Ultimo",
  "cc.pipelineUnavailable": "Stato pipeline non disponibile",
  ...
  "situations.notFound": "Situazione non trovata",
  "situations.back": "Torna alle situazioni",
  "situations.eventTimeline": "Timeline eventi",
  "situations.noLinkedEvents": "Nessun evento collegato trovato nei dati caricati",
  "situations.annotations": "Annotazioni",
  "situations.sharedLog": "Registro operativo condiviso",
  "situations.localFallback": "Modalità fallback locale",
  "situations.localFallbackAuth": "API condivisa non disponibile (auth/config). Modalità fallback locale",
  "situations.add": "Aggiungi",
  "situations.swissImpact": "Valutazione dell'impatto svizzero",
  "situations.recommendedActions": "Azioni raccomandate",
  ...
  "watchlists.sharedSynced": "Stato condiviso della lista sincronizzato",
  "watchlists.localFallback": "API condivisa non disponibile. Modalità lista locale",
  "watchlists.localFallbackAuth": "API condivisa non disponibile (auth/config). Modalità lista locale",
  ...
  "detail.sharedSynced": "Stato condiviso sincronizzato",
  "detail.localFallback": "Modalità fallback locale",
  "detail.localFallbackAuth": "API condivisa non disponibile (auth/config). Modalità fallback locale",
